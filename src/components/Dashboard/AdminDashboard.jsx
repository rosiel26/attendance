...
import { useBackgroundTheme, BACKGROUND_OPTIONS, applyTheme } from "../Common/Settings";
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 px-4 py-3 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 rounded-b-2xl">
      <p className="text-sm text-gray-500 dark:text-gray-400">
        Showing <span className="font-medium text-gray-700 dark:text-gray-200">{showingFrom}</span> to{" "}
        <span className="font-medium text-gray-700 dark:text-gray-200">{showingTo}</span> of{" "}
...
const AdminDashboard = () => {
  ...
  const { backgroundTheme, changeTheme: changeBackgroundTheme } = useBackgroundTheme();
  ...
  // Theme management - use background theme from Settings
  useEffect(() => {
    if (backgroundTheme) {
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-xl font-semibold transition-all duration-300 shadow-lg hover:shadow-xl"
        >
      ...
      <Card hover>
        ...
        <Pagination
          ...
          showingFrom={Math.min((currentPage - 1) * ITEMS_PER_PAGE + 1, filteredUsers.length)}
          showingTo={Math.min(currentPage * ITEMS_PER_PAGE, filteredUsers.length)}
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-xl font-semibold transition-all duration-300 shadow-lg hover:shadow-xl"
        >
      ...
      <Pagination
        ...
        showingFrom={Math.min((currentPageDepts - 1) * ITEMS_PER_PAGE + 1, departments.length)}
        showingTo={Math.min(currentPageDepts * ITEMS_PER_PAGE, departments.length)}
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-purple-500 hover:bg-purple-600 text-white rounded-xl font-semibold transition-all duration-300 shadow-lg hover:shadow-xl"
        >
          <PlusIcon className="w-5 h-5" />
      ...
      >
        <div className="space-y-4">
          <p className="text-gray-600 dark:text-gray-300">
            Are you sure you want to delete <strong>{holidayToDelete?.name}</strong>?
          </p>
          <p className="text-sm text-gray-500 dark:text-gray-400">
            This action cannot be undone.
          </p>
      ...
      <Pagination
        ...
        showingFrom={Math.min((currentPageHolidays - 1) * ITEMS_PER_PAGE + 1, holidays.length)}
        showingTo={Math.min(currentPageHolidays * ITEMS_PER_PAGE, holidays.length)}
